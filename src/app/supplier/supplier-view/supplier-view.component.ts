...
export class SupplierViewComponent {
  ...
  displayedColumns: string[] = ['id', 'razon_social', 'direccion', 'telefono', 'actions',];
  data: Supplier[] = [];
    ...
    merge(this.sort.sortChange, this.paginator.page)
      .pipe(
        ...
        switchMap(() => {
          ...
          const urlString = `suppliers/?page=${this.options.page}&size=${this.options.size}&search=${this.options.search}&orderBy=${this.options.orderBy}&orderDir=${this.options.orderDir}`;
  ...
  fetchAllOrders() {
    this.isLoadingResults = true;
    const urlString = `suppliers/?page=${this.paginator.pageIndex}&size=${this.paginator.pageSize}&search=${this.options.search}&orderBy=${this.sort.active}&orderDir=${this.sort.direction}`;
    this.repositoryService
      ...
      .subscribe((response: any) => {
        ...
        this.data = response.records as Supplier[];
      });
  }
  ...
  addSupplier() {
    this.router.navigate(['/dashboard/addsupplier']);
  }
